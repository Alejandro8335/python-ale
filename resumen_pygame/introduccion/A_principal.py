...
animaciones = []
for i in range(2):
    img = pygame.image.load(fr"C:\\Users\\gabri\\OneDrive\\Desktop\\ALE\\programacion\\python-ale\\resumen_pygame\\introduccion\\imagenes\\personaje\\player_{i}.png").convert_alpha()
...
#print(Contar("C:\\Users\\gabri\\OneDrive\\Desktop\\ALE\\programacion\\python-ale\\resumen_pygame\\introducción\\imagenes\\enemigo"))
...
#enemigos
dirrectorio_enegigos = r"C:\\Users\\gabri\\OneDrive\\Desktop\\ALE\\programacion\\python-ale\\resumen_pygame\\introduccion\\imagenes\\enemigo"
tipos_enemigos = Nombre(dirrectorio_enegigos)
animaciones_enemigos = []

for eni in tipos_enemigos:
    lista_temp = []
    ruta_temp = f"C:\\Users\\gabri\\OneDrive\\Desktop\\ALE\\programacion\\python-ale\\resumen_pygame\\introduccion\\imagenes\\enemigo\\{eni}"
...
#imagenes arco
img_arco = pygame.image.load(r"C:\\Users\\gabri\\OneDrive\\Desktop\\ALE\\programacion\\python-ale\\resumen_pygame\\introduccion\\imagenes\\armas\\arco.png").convert_alpha()
img_arco_escalado = escalar_img(img_arco, constantes.ANCHO_ARMA, constantes.ALTO_ARMA)

#imagenes de la balas
img_balas = pygame.image.load(r"C:\\Users\\gabri\\OneDrive\\Desktop\\ALE\\programacion\\python-ale\\resumen_pygame\\introduccion\\imagenes\\armas\\flecha.png").convert_alpha()
...
pocion = pygame.image.load(r"C:\\Users\\gabri\\OneDrive\\Desktop\\ALE\\programacion\\python-ale\\resumen_pygame\\introduccion\\items\\posion.png").convert_alpha()
pocion = escalar_img(pocion,constantes.ANCHO_POCION,constantes.ALTO_POCION)

monedas_images = []
ruta_monedas = r"C:\\Users\\gabri\\OneDrive\\Desktop\\ALE\\programacion\\python-ale\\resumen_pygame\\introduccion\\items\\moneda_"
num_monedas = 4
for i in range(num_monedas):
    img = pygame.image.load(fr"C:\\Users\\gabri\\OneDrive\\Desktop\\ALE\\programacion\\python-ale\\resumen_pygame\\introduccion\\items\\moneda_{i}.png").convert_alpha()
    img = escalar_img(img,constantes.ANCHO_MONEDAS,constantes.ALTO_MONEDAS)
    monedas_images.append(img)

#fuentes
font = pygame.font.Font(r"C:\\Users\\gabri\\OneDrive\\Desktop\\ALE\\programacion\\python-ale\\resumen_pygame\\introduccion\\imagenes\\fuente.ttf", 22)#el segundo valor es el tamaño
font_coins = pygame.font.Font(r"C:\\Users\\gabri\\OneDrive\\Desktop\\ALE\\programacion\\python-ale\\resumen_pygame\\introduccion\\imagenes\\fuente.ttf", 18)
font_game_over = pygame.font.Font(r"C:\\Users\\gabri\\OneDrive\\Desktop\\ALE\\programacion\\python-ale\\resumen_pygame\\introduccion\\imagenes\\fuente.ttf", 100)
font_reset = pygame.font.Font(r"C:\\Users\\gabri\\OneDrive\\Desktop\\ALE\\programacion\\python-ale\\resumen_pygame\\introduccion\\imagenes\\fuente.ttf", 75)
font_sonido = pygame.font.Font(r"C:\\Users\\gabri\\OneDrive\\Desktop\\ALE\\programacion\\python-ale\\resumen_pygame\\introduccion\\imagenes\\fuente.ttf", 25)
...
#corazones
corazon_lleno = pygame.image.load(r"C:\\Users\\gabri\\OneDrive\\Desktop\\ALE\\programacion\\python-ale\\resumen_pygame\\introduccion\\items\\corazon_lleno.png").convert_alpha()
corazon_lleno = escalar_img(corazon_lleno,constantes.ANCHO_CORAZONES,constantes.ALTO_CORAZONES)
corazon_medio = pygame.image.load(r"C:\\Users\\gabri\\OneDrive\\Desktop\\ALE\\programacion\\python-ale\\resumen_pygame\\introduccion\\items\\corazon_medio.png").convert_alpha()
corazon_medio = escalar_img(corazon_medio,constantes.ANCHO_CORAZONES,constantes.ALTO_CORAZONES)
corazon_vacio = pygame.image.load(r"C:\\Users\\gabri\\OneDrive\\Desktop\\ALE\\programacion\\python-ale\\resumen_pygame\\introduccion\\items\\corazon_vacio.png").convert_alpha()
...
list_tiles = []
for i in range(Contar(r"C:\\Users\\gabri\\OneDrive\\Desktop\\ALE\\programacion\\python-ale\\resumen_pygame\\introduccion\\tiles")):
    imagen = pygame.image.load(fr"C:\\Users\\gabri\\OneDrive\\Desktop\\ALE\\programacion\\python-ale\\resumen_pygame\\introduccion\\tiles\\{i}.png")
...
pygame.mixer.music.load(r"C:\\Users\\gabri\\OneDrive\\Desktop\\ALE\\programacion\\python-ale\\resumen_pygame\\introduccion\\sonidos\\ambiente.mp3")
...
sonido_pasos = pygame.mixer.Sound(r"C:\\Users\\gabri\\OneDrive\\Desktop\\ALE\\programacion\\python-ale\\resumen_pygame\\introduccion\\sonidos\\pasos.mp3")
sonido_puertas = pygame.mixer.Sound(r"C:\\Users\\gabri\\OneDrive\\Desktop\\ALE\\programacion\\python-ale\\resumen_pygame\\introduccion\\sonidos\\puertas.mp3")
